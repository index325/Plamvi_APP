      ...
      <View style={styles.box}>
        ...
        <View style={styles.productInfo}>
          <View style={styles.productHead}>
            <Text style={styles.productTitle}>{this.props.item.nome}</Text>
            <Text style={styles.productPrice}>R$ {this.props.item.preco}</Text>
          </View>
          ...
          <TouchableHighlight
            ...
            onPress={() => {
              this.handleNavigateToProdutoOverview(this.props.item._id);
            }}>
